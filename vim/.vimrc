...
imap #F <Esc>ldBi\frac{}{}<Esc>F{F{pf}f}i
...
if hostname == "arch-laptop" || hostname == "tom-linux"
    ...
    au VimEnter * call IMAP('#Hb', "\\begin{hangbf}{<++>}\<cr><++>\<cr>\\end{hangbf}\<cr><++>", 'tex')
    au VimEnter * call IMAP('#Hi', "\\begin{hangit}{<++>}\<cr><++>\<cr>\\end{hangit}\<cr><++>", 'tex')
    au VimEnter * call IMAP('#Hh', "\\begin{hang}\<cr><++>\<cr>\\end{hang}\<cr><++>", 'tex')
