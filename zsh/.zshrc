...
if [ $(hostname) = 'arch-laptop' ]; then
    ...
    export LD_LIBRARY_PATH=/home/tom/adolc_base/lib64:/usr/local/lib:/hdd/Downloads/Ipopt-3.12.13/build/lib:$LD_LIBRARY_PATH
    export LIBRARY_PATH=/home/tom/adolc_base/lib64:/usr/local/lib:/hdd/Downloads/Ipopt-3.12.13/build/lib:$LIBRARY_PATH
    export EDITOR=nvim
...
if [[ $(hostname) = 'tom-linux' ]]; then
    ...
    export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/home/tom/adolc_base/lib64:/home/tom/Downloads/Ipopt/lib
    export LIBRARY_PATH=$LIBRARY_PATH:/home/tom/adolc_base/lib64:/home/tom/Downloads/Ipopt/lib
    export EDITOR=nvim
